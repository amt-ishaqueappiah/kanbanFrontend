...
const Sidebar: React.FC<Props> = ({ sideViewToggle, boards, setHideSideBar, hideSideBar }: Props) => {
    ...
    return (
        <nav
            className={
                `${sideViewToggle === false ? "sidebar side-bar-toggle" : "sidebar"}
                ${hideSideBar===true?"close":'sidebar'}
                `
                
            }
        >
            <section className="sideBarModal">
                <div className="sidebarTop">
                 <svg
                        className="kanbanMainlogo"
                        width="153"
                        height="26"
                    ...
                    <p className="allBoards text-light">
                    ...
                    <p
                        ...
                        onClick={(e) => setAddNewBoard(!addNewBoard)}
                    >
                        + Create New Board
                    </p>
                </div>
                ...
                <div className="sidebarBottom">
                    <ThemeToggle />
                  <div className="hideSidebar text-light" onClick={handleSideBarToggle}>
                        <svg
                            width="18"
                            height="16"
                            xmlns="http://www.w3.org/2000/svg"
